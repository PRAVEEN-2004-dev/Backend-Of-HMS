...
public class AppoinmentController {
	...
	public AppoinmentController(AppointmentRepository appointmentRepository) {
		super();
	...
	public Appoinment createAppointment(@RequestBody Appoinment appointment) {
		System.out.println("inside insert"+appointment);
	...
	public ResponseEntity<Map<String, Boolean>>deleteAppointment(@PathVariable long id) throws AttributeNotFoundException{
		...
		Appoinment appointment= appointmentRepository.findById(id).orElseThrow (()-> new AttributeNotFoundException("Appointment not found with id "+id));
